				...
				<table id = "table" class = "table table-bordered">
					<thead>
						<tr>
							...
							<th class="text-center">N° contact</th>
							<th class="text-center">Type chambre</th>
							<th class="text-center">Date réservation</th>
							<th class="text-center">Date sorti</th>
